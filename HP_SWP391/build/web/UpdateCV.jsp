                                        ...
                                        <div class="col-md-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h4 class="card-title">Update CV</h4>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group row align-items-center">
                                                                ...
                                                                <div class="col-lg-10 col-9">
                                                                    <textarea rows="1" id="helperText" class="form-control" name="intro"
                                                                              required="">${mp.introduction}</textarea>
                                                                </div>
                                                            </div> 
                                                        </div>                                           
                                                    </div>
                                                    ...
                                                    <div class="form-group row align-items-center">
                                                        ...
                                                        <div class="col-lg-10 col-9">
                                                            <div style="display: flex; justify-content: space-between">
                                                                <input type="hidden" name="msID1" value="${ms1.mentorSkillID}">
                                                                <select class="form-control" name="skill1">
                                                                    <option disabled="disabled" selected="selected">Choose skill</option>
                                                                    <c:forEach items="${listS}" var="s">
                                                                        <c:if test="${s.status}">
                                                                            <c:if test="${ms1.skillID==s.skillID}">
                                                                                <option selected="selected" value="${s.skillID}">${s.skillName}</option>
                                                                            </c:if>
                                                                            <c:if test="${ms1.skillID!=s.skillID}">
                                                                ...
                                                                <input type="text" id="helperText" class="form-control" name="desc1"
                                                                       value="${ms1.description}">
                                                            </div>

                                                            <div style="display: flex; justify-content: space-between">
                                                                <input type="hidden" name="msID2" value="${ms2.mentorSkillID}">
                                                                <select class="form-control" name="skill2">
                                                                    <option disabled="disabled" selected="selected">Choose skill</option>
                                                                    <c:forEach items="${listS}" var="s">
                                                                        <c:if test="${s.status}">
                                                                            <c:if test="${ms2.skillID==s.skillID}">
                                                                                <option selected="selected" value="${s.skillID}">${s.skillName}</option>
                                                                            </c:if>
                                                                            <c:if test="${ms2.skillID!=s.skillID}">
                                                                                <option value="${s.skillID}">${s.skillName}</option>
                                                                ...
                                                                <input type="text" id="helperText" class="form-control" name="desc2"
                                                                       value="${ms2.description}">
                                                            </div>

                                                            <div style="display: flex; justify-content: space-between">
                                                                <input type="hidden" name="msID3" value="${ms3.mentorSkillID}">
                                                                <select class="form-control" name="skill3">
                                                                    <option disabled="disabled" selected="selected">Choose skill</option>
                                                                    <c:forEach items="${listS}" var="s">
                                                                        <c:if test="${s.status}">
                                                                            <c:if test="${ms3.skillID==s.skillID}">
                                                                                <option selected="selected" value="${s.skillID}">${s.skillName}</option>
                                                                            </c:if>
                                                                            <c:if test="${ms3.skillID!=s.skillID}">
                                                                                <option value="${s.skillID}">${s.skillName}</option>
